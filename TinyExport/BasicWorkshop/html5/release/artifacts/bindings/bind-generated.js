...
Object.defineProperties(entities.game.ExplosionGroup.Component, { cid: { configurable: true, get: function() { delete entities.game.ExplosionGroup.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.ExplosionGroup.Component.cid = Module._ut_component_register_cid(/*entities.game.ExplosionGroup.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::ExplosionGroup::Component"*/, 0, 0); } } });
...
Object.defineProperties(entities.game.MainGroup.Component, { cid: { configurable: true, get: function() { delete entities.game.MainGroup.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.MainGroup.Component.cid = Module._ut_component_register_cid(/*entities.game.MainGroup.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::MainGroup::Component"*/, 0, 0); } } });
...
Object.defineProperties(entities.game.EnemyGroup.Component, { cid: { configurable: true, get: function() { delete entities.game.EnemyGroup.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.EnemyGroup.Component.cid = Module._ut_component_register_cid(/*entities.game.EnemyGroup.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::EnemyGroup::Component"*/, 0, 0); } } });
...
Object.defineProperties(game.ScrollingBackground, { cid: { configurable: true, get: function() { delete game.ScrollingBackground.cid; var offsetsPtr = 0, offsetsCount = 0; return game.ScrollingBackground.cid = Module._ut_component_register_cid(/*game.ScrollingBackground*/ 12, 4, 0, offsetsPtr, offsetsCount, 0/*"game::ScrollingBackground"*/, 0, 0); } } });
...
Object.defineProperties(game.MoveSpeed, { cid: { configurable: true, get: function() { delete game.MoveSpeed.cid; var offsetsPtr = 0, offsetsCount = 0; return game.MoveSpeed.cid = Module._ut_component_register_cid(/*game.MoveSpeed*/ 4, 4, 0, offsetsPtr, offsetsCount, 0/*"game::MoveSpeed"*/, 0, 0); } } });
...
Object.defineProperties(game.MoveWithInput, { cid: { configurable: true, get: function() { delete game.MoveWithInput.cid; var offsetsPtr = 0, offsetsCount = 0; return game.MoveWithInput.cid = Module._ut_component_register_cid(/*game.MoveWithInput*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::MoveWithInput"*/, 0, 0); } } });
...
Object.defineProperties(game.EnemyTag, { cid: { configurable: true, get: function() { delete game.EnemyTag.cid; var offsetsPtr = 0, offsetsCount = 0; return game.EnemyTag.cid = Module._ut_component_register_cid(/*game.EnemyTag*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::EnemyTag"*/, 0, 0); } } });
...
Object.defineProperties(game.Spawner, { cid: { configurable: true, get: function() { delete game.Spawner.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Spawner.cid = Module._ut_component_register_cid(/*game.Spawner*/ 20, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Spawner"*/, ut.DestructorFn._cb.token_for(game.Spawner._dtorFn), ut.CopyFn._cb.token_for(game.Spawner._copyFn)); } } });
...
game.Spawner.spawnGroup = { $ofs:12, $t:"System.String", $c:game.Spawner };
